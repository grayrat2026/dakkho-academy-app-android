...
class DakkhoTheme {
  ...
  // ─── Light Theme (PRIMARY — matches web app :root) ───
  static ThemeData lightTheme = ThemeData(
    useMaterial3: true,
    brightness: Brightness.light,
    scaffoldBackgroundColor: DakkhoColors.bgLight,  // #F0F9FF sky-50
    colorScheme: const ColorScheme.light(
      primary: DakkhoColors.primary,             // #0EA5E9 sky-500
      onPrimary: Colors.white,
      secondary: DakkhoColors.accent,            // #10B981 emerald-500
      onSecondary: Colors.white,
      tertiary: DakkhoColors.purple,
      onTertiary: Colors.white,
      error: DakkhoColors.danger,
      onError: Colors.white,
      surface: DakkhoColors.surfaceWhite,        // white
      onSurface: DakkhoColors.textPrimaryLight,  // #0F172A slate-900
      surfaceContainerHighest: DakkhoColors.surfaceLightMode, // #F1F5F9 slate-100
      outline: DakkhoColors.textSecondaryLight,  // #64748B slate-500
      outlineVariant: DakkhoColors.inputLight,   // #E2E8F0 slate-200
    ),
    primaryColor: DakkhoColors.primary,
    canvasColor: DakkhoColors.bgLight,
    cardColor: DakkhoColors.surfaceWhite,
    dividerColor: DakkhoColors.inputLight,
    ...
    appBarTheme: const AppBarTheme(
      ...
      titleTextStyle: TextStyle(
        ...
        fontSize: 18,
        fontWeight: FontWeight.w700,
        color: DakkhoColors.textPrimaryLight,  // slate-900
      ),
      iconTheme: IconThemeData(color: DakkhoColors.textPrimaryLight, size: 24),
      systemOverlayStyle: SystemUiOverlayStyle.dark,
    ),

    // ─── Card ───
    cardTheme: CardThemeData(
      color: DakkhoColors.glassCardBgLight,  // white @ 70%
      elevation: 0,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: const BorderSide(color: DakkhoColors.glassCardBorderLight, width: 1),
      ),
      margin: EdgeInsets.zero,
    ),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        foregroundColor: DakkhoColors.textPrimaryLight,
        backgroundColor: Colors.transparent,
        side: const BorderSide(color: DakkhoColors.inputLight, width: 1.5),
        padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 14),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(12),
        ),
    ...
    // ─── Icon Theme ───
    iconTheme: const IconThemeData(
      color: DakkhoColors.textPrimaryLight,
      size: 24,
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      filled: true,
      fillColor: DakkhoColors.surfaceLightMode,  // slate-100
      hintStyle: const TextStyle(color: DakkhoColors.textSecondaryLight),
      labelStyle: const TextStyle(color: DakkhoColors.textSecondaryLight),
      prefixIconColor: DakkhoColors.textSecondaryLight,
      suffixIconColor: DakkhoColors.textSecondaryLight,
      contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: DakkhoColors.inputLight, width: 1),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: DakkhoColors.inputLight, width: 1),
    ...
    // ─── Bottom Navigation Bar ───
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      backgroundColor: DakkhoColors.glassSidebarLight,
      selectedItemColor: DakkhoColors.primary,
      unselectedItemColor: DakkhoColors.textSecondaryLight,
      type: BottomNavigationBarType.fixed,
      showUnselectedLabels: true,
      elevation: 0,
    ),
    ...
    // ─── Snackbar ───
    snackBarTheme: SnackBarThemeData(
      backgroundColor: DakkhoColors.surfaceLightMode,
      contentTextStyle: const TextStyle(
        fontFamily: 'Inter',
        fontFamilyFallback: ['NotoSansBengali'],
        color: DakkhoColors.textPrimaryLight,
    ...
    // ─── Dialog ───
    dialogTheme: DialogThemeData(
      backgroundColor: DakkhoColors.surfaceWhite,
      elevation: 0,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(20),
      ),
    ...
    chipTheme: ChipThemeData(
      ...
      side: const BorderSide(color: DakkhoColors.inputLight, width: 1),
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(20),
      ),
    ),
    ...
    progressIndicatorTheme: const ProgressIndicatorThemeData(
      color: DakkhoColors.primary,
      linearTrackColor: DakkhoColors.surfaceLightMode,
    ),
    ...
    switchTheme: SwitchThemeData(
      thumbColor: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.selected)) return DakkhoColors.primary;
        return DakkhoColors.textSecondaryLight;
      }),
      trackColor: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.selected)) return DakkhoColors.primary.withValues(alpha: 0.4);
        return DakkhoColors.inputLight;
      }),
    ),
    ...
    sliderTheme: SliderThemeData(
      activeTrackColor: DakkhoColors.primary,
      inactiveTrackColor: DakkhoColors.inputLight,
      thumbColor: DakkhoColors.primary,
      overlayColor: DakkhoColors.primary.withValues(alpha: 0.2),
    ),
    ...
    tabBarTheme: TabBarThemeData(
      labelColor: DakkhoColors.primary,
      unselectedLabelColor: DakkhoColors.textSecondaryLight,
      indicatorColor: DakkhoColors.primary,
      labelStyle: const TextStyle(
        fontFamily: 'Inter',
        fontFamilyFallback: ['NotoSansBengali'],
    ...
    // ─── List Tile ───
    listTileTheme: const ListTileThemeData(
      iconColor: DakkhoColors.textSecondaryLight,
      textColor: DakkhoColors.textPrimaryLight,
      titleTextStyle: TextStyle(
        fontFamily: 'Inter',
        fontFamilyFallback: ['NotoSansBengali'],
        fontSize: 15,
      ...
      subtitleTextStyle: TextStyle(
        ...
        fontSize: 13,
        fontWeight: FontWeight.w400,
        color: DakkhoColors.textSecondaryLight,
      ),
    ),
  ...
  // ─── Dark Theme (optional — matches web app .dark) ───
}
