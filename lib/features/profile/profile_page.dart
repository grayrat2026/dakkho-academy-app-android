        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  if (user?.technologyName != null) ...[
                    ...
                    Container(
                      ...
                      child: Text(user!.technologyName!,
            ...
            GlassCard(
              ...
              child: const Row(
                children: [
                  Icon(LucideIcons.userCog, color: DakkhoColors.primary, size: 22),
                  SizedBox(width: 16),
                  Expanded(child: Text('Edit Profile', style: TextStyle(fontWeight: FontWeight.w600))),
                  Icon(LucideIcons.chevronRight, color: DakkhoColors.textSecondary, size: 18),
                ],
              ),
            ),
            const SizedBox(height: 8),
            GlassCard(
              onTap: () => context.go('/app/profile/learning-stats'),
              padding: const EdgeInsets.all(16),
              child: const Row(
                children: [
                  Icon(LucideIcons.barChart3, color: DakkhoColors.primary, size: 22),
                  SizedBox(width: 16),
                  Expanded(child: Text('Learning Stats', style: TextStyle(fontWeight: FontWeight.w600))),
                  Icon(LucideIcons.chevronRight, color: DakkhoColors.textSecondary, size: 18),
                ],
              ),
            ),
